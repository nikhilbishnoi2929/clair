...
const AboutCLAIR = () => {
    return (
        <section className=' bg_color mt--2 position-relative'>
                            ...
                            <div className=' d-flex flex-column'>
                                <div className=' z-3  d-flex gap-28'>
                                    <div className=' z-3  d-flex flex-column'>
                                        <h3 className=' fw-400 fs-md line-24 mb-0  para-color  '>1 $Clair  </h3>
                                        <h4 className=' yellow fw-700 fs-md line-24 mb-0  pt_4'> 0.00387 $</h4>
                                    </div>
                                    <div className=' z-3  center_line'>

                                    </div>
                                    <div className=' z-3  d-flex flex-column'>
                                        <h3 className=' fw-400 fs-md line-24 mb-0  para-color  '>Raised Amount  </h3>
                                        <h4 className=' yellow fw-700 fs-md line-24 mb-0  pt_4'>332,123$</h4>
                                    </div>
                                </div>
            ...
            <div className=' position-absolute ellips_2 z-0' >
                <img src={ellips_2} alt="ellips_2" />
            </div>
            <div className=' position-absolute man_ellips z-0' >
                <img src={man_ellips} alt="ellips_2" />
            </div>
        </section>
    )
}
