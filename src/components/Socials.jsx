...
import mansvg from '../assets/image/svg/mansvg.svg'
...
const Socials = () => {
  ...
  <section className=' bg-black mt--2 position-relative'>
        ...
        <div className=' d-flex justify-content-center '>
            <div className='z-3 d-flex flex-column align-items-center'>
                ...
                <div className=' d-flex z-3 gap-16 pt-32'>
                    <div className='z-3 cirlce_media cursor  d-flex justify-content-center align-items-center'>
    ...
    <div className=' mansvg position-absolute z-2'>
