  ...
  return (
     <section className=' freq_bg  position-relative' id='section5'>
       ...
       <div className=' d-flex justify-content-center'>
            <h3 className=' manrope mb-0 text-center fw-600 fs-4xl line-57 white-1 ' data-aos="flip-left">Frequently Asked  <span className='yellow'>Questions</span></h3>
        </div>
        <div className=' max-w-800 pt-60 mx-auto'>
        <Accordion defaultActiveKey="0" >
                                <Accordion.Item eventKey="0"data-aos="zoom-out-left z-3 ">
                                ...
                                <Accordion.Item eventKey="1" className='mt-24 z-3 'data-aos="zoom-out-right">
                                ...
                                <Accordion.Item eventKey="3" className='mt-24 z-3'data-aos="zoom-out-left">
                                ...
                                <Accordion.Item eventKey="4" className='mt-24 z-3'data-aos="zoom-out-right">
                                ...
                                <Accordion.Item eventKey="5" className='mt-24 z-3'data-aos="zoom-out-left">
                                ...
                                <Accordion.Item eventKey="6" className='mt-24 z-3'data-aos="zoom-out-right">
                                ...
                                <Accordion.Item eventKey="7" className='mt-24 z-3'data-aos="zoom-out-left">
