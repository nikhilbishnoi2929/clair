...
const Frequently = () => {
  return (
     <section className=' freq_bg  position-relative' >
       ...
       <div className=' d-flex justify-content-center'>
        ...
        <Accordion defaultActiveKey="0" >
                                ...
                                <Accordion.Item eventKey="1" className='mt-24 'data-aos="fade-right">
                                ...
                                <Accordion.Item eventKey="3" className='mt-24'data-aos="fade-left">
                                ...
                                <Accordion.Item eventKey="4" className='mt-24'data-aos="fade-right">
                                ...
                                <Accordion.Item eventKey="5" className='mt-24'data-aos="fade-left">
                                ...
                                <Accordion.Item eventKey="6" className='mt-24'data-aos="fade-right">
                                ...
                                <Accordion.Item eventKey="7" className='mt-24'data-aos="fade-left">
