        ...
        <section className='bg_img_3 mt--2 position-relative '>
            <div className=' container max-w-1140 px-152'>
                <div className=' d-flex justify-content-center '>
                    ...
                    <button className=' manrope fw-700 fs-md d-none d-md-block line-24 black btn_copy'> Copy</button>

                </div>
                <button className=' manrope fw-700 fs-md line-24 black btn_copy mt-3 d-block d-md-none'> Copy</button>
            ...
            <div className=' position-absolute ellips-3 z-0'>
