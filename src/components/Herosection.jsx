...
const Herosection = () => {
  ...
  return (
    <header className=' bg_image_hero  position-relative'>
        ...
        <nav className=' container max-w-1140'>
          <div className=' d-flex justify-content-between align-items-center'>
            ...
            <div className=' d-flex gap-60 align-items-center'>
              <ul className={` ps-0 mb-0 d-flex gap-32 ${ show ? "end-0" : "rigth_100"

              } `}>
                <li className=''> <a href="#section1" className=' manrope about_hover fw-500 fs-md line-24 para-color '>About</a></li>
                <li className=''> <a href="#section2" className=' manrope about_hover  fw-500 fs-md line-24 para-color '>Tokenomics</a></li>
                <li className=''> <a href="#section3" className=' manrope about_hover fw-500 fs-md line-24 para-color '>Audit</a></li>
                <li className=''> <a href="#section4" className=' manrope about_hover fw-500 fs-md line-24 para-color '>Roadmap</a></li>
                <li className=''> <a href="#section5" className=' manrope  about_hover fw-500 fs-md line-24 para-color '>White Paper</a></li>
              ...
              <div className='dropdown'>
                ...
                <div class="dropdown-content">
                  ...
                  <a href="#" className=' yellow'>Link 2</a>
      ...
      <div className=' container max-w-1140' id='section1'>
        <div className=' z-3  d-flex justify-content-center pt-50'>
          <div className=' z-3  d-flex flex-column align-items-center '>
            <h1 className='z-3 manrope fw-700 fs-5xl line-72 mb-0 white-1 '>Presale is  <span className=' yellow'>Live</span></h1>
            <p className=' z-3 para-color-2 mb-0 fw-400 fs-md line-24 pt-16 max-w-702 text-center manrope '> Led by the most advanced AI technology, with a unique burn system to potentially increase its value significantly. Secure your chance to become the next millionaire!</p>
            <button className=' z-3  manrope fw-700 fs-md line-24 d-flex gap-10 text-nowrap  mt-35  black buy_btn'>Buy $Clair <span className='svg_path'><svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className=' position-absolute elleps-1  z-0'>
        <img src={elleps1} alt="elleps1" />
      </div>
      <div className=' position-absolute hero_position z-3'>
        <a href="#section6">   <img src={hero_position} alt="elleps1" /></a>
      </div>
    </header>
  )
}
