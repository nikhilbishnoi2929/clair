...
return (
  <header className=' bg_image_hero min-vh_1 00  position-relative z-3'>
      ...
      <nav className=' container max-w-1140'>
        <div className=' d-flex justify-content-between align-items-center'>
          ...
          <div className=' d-flex gap-60 align-items-center'>
            <ul className={` ${show ? "" : "start-0"} ps-0 mb-0 d-flex gap-32 mobile_view `}>


              <li className='' onClick={handleClick}> <a href="#section1" className=' manrope z-3 about_hover fw-500 fs-md line-24 para-color '>About</a></li>
              <li className='' onClick={handleClick}> <a href="#section2" className=' manrope about_hover  fw-500 fs-md line-24 para-color '>Tokenomics</a></li>
              <li className='' onClick={handleClick}> <a href="#section3" className=' manrope about_hover fw-500 fs-md line-24 para-color '>Audit</a></li>
              <li className='' onClick={handleClick}> <a href="#section4" className=' manrope about_hover fw-500 fs-md line-24 para-color '>Roadmap</a></li>
              <li className='' onClick={handleClick}> <a href="#section5" className=' manrope  about_hover fw-500 fs-md line-24 para-color '>White Paper</a></li>
            ...
            <div onClick={() => setShow(!show)} className={`${show ? "menu" :"cross" }   d-flex flex-column gap-2 d-md-none`}>
    ...
    <div className=' position-absolute hero_position    z_3 '>
      <a href="#section6" onClick={handleClick}>   <img src={hero_position} alt="elleps1" /></a>
    </div>
  </header>
)
}
