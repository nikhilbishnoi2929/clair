...
const Herosection = () => {
  return (
    <header className=' bg_image_hero  position-relative'>
        ...
        <nav className=' container max-w-1140'>
          <div className=' d-flex justify-content-between align-items-center'>
            ...
            <div className=' d-flex gap-60 align-items-center'>
              <ul className=' ps-0 mb-0 d-flex gap-32 '>
                <li className=''> <a href="" className=' manrope about_hover fw-500 fs-md line-24 para-color '>About</a></li>
                <li className=''> <a href="" className=' manrope about_hover  fw-500 fs-md line-24 para-color '>Tokenomics</a></li>
                <li className=''> <a href="" className=' manrope about_hover fw-500 fs-md line-24 para-color '>Audit</a></li>
                <li className=''> <a href="" className=' manrope about_hover fw-500 fs-md line-24 para-color '>Roadmap</a></li>
                <li className=''> <a href="" className=' manrope  about_hover fw-500 fs-md line-24 para-color '>White Paper</a></li>
      ...
      <div className=' position-absolute hero_position z-0'>
        <img src={hero_position} alt="elleps1" />
      </div>
    </header>
  )
}
